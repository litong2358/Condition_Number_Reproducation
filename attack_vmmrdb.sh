#!/bin/bash
#SBATCH --job-name=cn_vmmrdb
#SBATCH --output=logs/vmmrdb_%j.out
#SBATCH --error=logs/vmmrdb_%j.err
...
python attack_vmmrdb.py \
    ...
    --output_dir results/attack_vmmrdb_seed1/ \
